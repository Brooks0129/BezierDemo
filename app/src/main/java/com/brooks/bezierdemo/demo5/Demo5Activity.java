...
package com.brooks.bezierdemo.demo5;
...
public class Demo5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(Demo5Activity.this));
    }
    ...
    class MyAdapter extends RecyclerView.Adapter<MyVH> {
        ...
        public MyVH onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(Demo5Activity.this);
    ...
    private void addCart( ImageView iv) {
        ...
        final ImageView goods = new ImageView(Demo5Activity.this);
